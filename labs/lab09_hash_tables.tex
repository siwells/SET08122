...
After inserting the elements, , print the contents of the array to the screen. It should look like this: [-, 1, 2, 13, 12, 5, 6, 17, 39, -, -], where Ð marks an empty bucket in the array.
